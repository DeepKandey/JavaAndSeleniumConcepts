...
public class CommonConstants {
	...
	public static String TESTDOCUMENT_FILEPATH = System.getProperty("user.dir")
			+ "/src/test/resources/ExcelFiles/TestDocument.xlsx";
	
	public static String TESTNGSUITE_FILEPATH = System.getProperty("user.dir")
			+ "/src/test/resources/ExcelFiles/testng-suite.xml";
