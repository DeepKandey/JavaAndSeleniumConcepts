...
public class GoIbiboAssignment {
	...
	public void flightBookingTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("descendant::input[@class='form-control inputTxtLarge widgetCalenderTxt'][1]"))
				.click();
		...
		driver.findElement(
				By.xpath("//div[@class='DayPicker-Week']//*[@class='DayPicker-Day DayPicker-Day--selected']")).click();
		...
		List<WebElement> listOfDepartureTime = driver.findElements(By.xpath(
		...
		List<WebElement> listOfReturnTime = driver.findElements(By.xpath(
		...
		wait.until(ExpectedConditions.visibilityOf(
				driver.findElement(By.xpath("//div[@class='blueBgLt fl padTB10 width100 ']/span[1]/span"))));

		String totalAmountTxt = driver
				.findElement(By.xpath("//div[@class='blueBgLt fl padTB10 width100 ']/span[1]/span"))
				.getAttribute("innerHTML");

		String proceedToPaymentTxt = driver.findElement(By.xpath("//button[@class='button orange col-md-3 fr large']"))
				.getAttribute("innerHTML");
