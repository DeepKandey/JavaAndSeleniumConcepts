...
public class MakeMyTrip {
    ...
    public void flightSearch() throws InterruptedException {
        ...
        while (!driver
                .findElement(
                        By.xpath(
                                "descendant::div[@class ='ui-datepicker-title'][1]/span[@class='ui-datepicker-month']"))
                .getText()
                .contains("OCTOBER")) {
            driver
                    .findElement(
                            By.xpath(
                                    "descendant::a[@data-handler='next'][1]//span[@class='ui-icon ui-icon-circle-triangle-e']"))
                    .click();
        }

        int daysInDepartureMonth =
                driver
                        .findElements(
                                By.xpath(
                                        "descendant::table[@class='ui-datepicker-calendar'][1]//td[@data-handler='selectDay']"))
                        .size();
        ...
        while (!driver
                .findElement(
                        By.xpath(
                                "descendant::div[@class ='ui-datepicker-title'][3]/span[@class='ui-datepicker-month']"))
                .getText()
                .contains("OCTOBER")) {
            driver
                    .findElement(
                            By.xpath(
                                    "descendant::a[@data-handler='next'][2]//span[@class='ui-icon ui-icon-circle-triangle-e']"))
                    .click();
        }

        int daysInReturnMonth =
                driver
                        .findElements(
                                By.xpath(
                                        "descendant::table[@class='ui-datepicker-calendar'][3]//td[@data-handler='selectDay']"))
                        .size();
