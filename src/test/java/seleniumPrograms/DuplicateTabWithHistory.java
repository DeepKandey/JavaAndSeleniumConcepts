...
public class DuplicateTabWithHistory {
	...
	public void testDuplicateTabWithHistory() throws AWTException {
		...
		new WebDriverWait(driver, Duration.ofSeconds(10).getSeconds()).until(ExpectedConditions.numberOfWindowsToBe(2));
		...
		new WebDriverWait(driver, Duration.ofSeconds(10).getSeconds()).until(ExpectedConditions.titleIs("Google"));
