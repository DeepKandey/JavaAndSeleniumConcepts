...
public class StringHandling {
	...
	public static void main(String[] args) {
		...
		System.out.println("Length of the string using s.lastIndexOf(\"i\")+1): " + (s.lastIndexOf("i")+1));
		System.out.println("Length of the string using s.toCharArray().length: " + s.toCharArray().length);
