...
public class ArmstrongNumber {
  ...
  public static void main(String[] args) {
    ...
    int sumofDigitsRaisedToPowerOfNumberOfDigits =
        getSumofDigitsRaisedToPowerOfNumberOfDigits(Number, numberOfDigits);
    System.out.println(
        "Sum of Digits in the Number raised to power of number of digits-->"
