...
public class MapInterfaceExamples {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Value for director: " + hashMap.getOrDefault("director", "Not present")); // getOrDefault added in Java 8
        ...
        System.out.println("Map comparison on the basis of keySet: " + hashMap.keySet().equals(hashMap1.keySet()));
        ...
        System.out.println("map1 and map2 values comparison using ArrayList: " + new ArrayList<>(map1.values()).equals(new ArrayList<>(map2.values())));
        System.out.println("map1 and map3 values comparison using ArrayList: " + new ArrayList<>(map1.values()).equals(new ArrayList<>(map3.values())));

        // duplicates are not allowed
        System.out.println("map1 and map2 values comparison using HashSet: " + new HashSet<>(map1.values()).equals(new HashSet<>(map2.values())));
        ...
        // TreeMap - implements NavigableMap interface( extends sortedMap interface). It is naturally ordered.
