...
public class PrivateClassOfInnerClass {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Constructor<?> constructorOfprivateClassOfInnerClass = privateClassOfInnerClass
			...
			Method method = privateClassOfInnerClass.getDeclaredMethod("powerof2", new Class[] { int.class });
