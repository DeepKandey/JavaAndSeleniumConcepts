    ...
    try {
      Repository existingRepo =
          new FileRepositoryBuilder()
              .setGitDir(new File("C:/Users/deepa/workspace/JavaAndSeleniumConcepts/.git"))
              .build();
      ...
      git.branchList().setListMode(ListMode.ALL).call().stream()
      ...
      System.out.println("\n>>> Committing changes\n");
      RevCommit revCommit =
          git.commit().setOnly("pom.xml").setMessage("Adding commit from JGIT").call();
