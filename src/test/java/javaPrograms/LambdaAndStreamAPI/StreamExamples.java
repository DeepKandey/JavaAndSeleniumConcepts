...
public class StreamExamples {
	...
	public static void main(String[] args) {
		...
		// comparing
		Optional<Student> opStudent = Stream.of(a1, b1, c1).min(Comparator.comparing(s -> s.getScore()));
		System.out.println(opStudent.get());

		// takeWhile (Java 9)
		Stream<Integer> takeWhileStream = Stream.of(4, 2, 1, 5, 7, 1, 3, 9);
		System.out.println("Take-while till it is lesser than 5: "
				+ takeWhileStream.takeWhile(i -> i < 5).collect(Collectors.toList()));

		// dropWhile (Java 9)
		Stream<Integer> dropWhileStream = Stream.of(4, 2, 1, 5, 7, 1, 3, 9);
		System.out.println("Drop-while till it is greater than or equal to 5: "
