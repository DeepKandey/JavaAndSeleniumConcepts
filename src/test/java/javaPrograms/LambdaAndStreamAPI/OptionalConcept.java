...
public class OptionalConcept {
  ...
  public static void main(String[] args) {
    ...
    // isPresent() and get()
    if (optionalString.isPresent()) System.out.println(optionalString.get().toUpperCase());
    else System.out.println("value not present: " + optionalString);
    ...
    // isEmpty()
    if (optionaIsEmpty.isEmpty()) System.out.println(optionalString);
  }
}
